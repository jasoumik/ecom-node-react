...
export function TestimonialsSection({
  ...
  return (
    <Section className="py-32 !bg-sky-50 relative overflow-hidden dark:!bg-slate-950 transition-colors duration-300">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div key={t.id} className={`bg-white p-10 rounded-[2.5rem] border border-sky-100 shadow-xl shadow-sky-100/50 hover:-translate-y-2 transition-transform duration-300 ${i === 1 ? 'md:-translate-y-8' : ''} dark:bg-slate-800 dark:border-slate-700 dark:shadow-none`}>
              <div className="flex gap-1 mb-6">
                <RatingStars rating={t.rating || 5} />
              </div>
              
              <Text className="text-xl font-medium text-slate-700 leading-relaxed mb-8 font-sans dark:text-slate-300">
                "{t.quote}"
              </Text>
