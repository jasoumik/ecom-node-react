    ...
    <>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 print:bg-white print:p-0 print:min-h-0">
        <div className="max-w-4xl mx-auto px-4 print:max-w-none print:px-0 print:mx-0">
          ...
          <div id="invoice-content" className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 print:shadow-none print:border-0 print:rounded-none print:bg-white print:text-black print:p-0">
            {/* Header */}
            <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-10 border-b border-slate-100 dark:border-slate-700 pb-8 print:border-slate-200">
            ...
            {/* Items */}
            <div className="overflow-hidden rounded-xl border border-slate-100 dark:border-slate-700 mb-8 print:border-slate-200">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-700 print:divide-slate-200">
                    ...
                    <tr key={item.id}>
                        ...
                        <td className="print:hidden text-right px-2">
                            {(order.status === 'completed' || order.status === 'delivered') && (
                                <button 
                                    onClick={() => setReviewProduct({ id: item.product_id, name: item.product_name })}
                                    className="text-xs font-bold text-sky-600 hover:underline whitespace-nowrap"
